...
| P2.2 | Archive batch B (8 rows above; referencing test/script/workflow lines updated in the same PR; no behavioural assertion pinned archived prose, so the assertion-retirement set was empty) | #TBD | 2026-07-05 | EXECUTED |
